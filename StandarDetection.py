...
def draw_boxes(image, boxes, class_names, scores, max_boxes=15, min_score=0.05):
...
while(True):
    ...
    run_detector(detector, ".\image.png")
...
run_detector(detector, ".\image.png")
run_detector(detector, ".\Tar02.jpg")
run_detector(detector, ".\Tar03.jpg")
